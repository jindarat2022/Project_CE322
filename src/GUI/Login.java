...
public class Login {
    ...
    public Login() {
        ...
        info_Label = new JLabel("           Login           ");
        Image_jLabel = new JLabel();

        UN_TextField = new JTextField();
        Password_Field = new JPasswordField();

        MiniPanel.setBackground(Color.DARK_GRAY);
        ...
        Image_jLabel.setIcon(new ImageIcon("sale.jpg"));
        ...
        MainPanel.add(MiniPanel, new AbsoluteConstraints(250, 150, 350, 125));
    ...
    private class LoginActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            switch (e.getActionCommand()) {
                ...
                case "Login": {
                    if (UN_TextField.getText().trim().equalsIgnoreCase("gun")
