...
public class MainMenu implements ActionListener {
    ...
    public MainMenu() {
        ...
        LogoutButton.setFont(new Font("Tahoma", 1, 18));
        CustomerButton.setFont(new Font("Tahoma", 1, 18));
        CarsButton.setFont(new Font("Tahoma", 1, 18));
        OwnerButton.setFont(new Font("Tahoma", 1, 18));
        BookingButton.setFont(new Font("Tahoma", 1, 18));
        ...
        MainPanel.add(CustomerButton, new AbsoluteConstraints(500, 220, 200, 99));
        MainPanel.add(CarsButton, new AbsoluteConstraints(500, 500, 200, 99));
        MainPanel.add(OwnerButton, new AbsoluteConstraints(500, 360, 200, 99));
        MainPanel.add(BookingButton, new AbsoluteConstraints(500, 80, 200, 99));
